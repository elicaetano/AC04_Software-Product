...
header("content-type:text/html;charset=utf8");#include 'navegacao.html';
require "conexao.php";

$tiposangue=$_GET['tiposangue'];

$sql="SELECT * FROM doador WHERE Grupo_Sanguineo='$tiposangue'";
...
<button style="color:red;font-size:20px;" type="button"><a href="consultaDoador.php">Voltar</a></button>
